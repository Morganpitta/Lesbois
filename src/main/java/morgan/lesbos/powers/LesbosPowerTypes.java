...
public class LesbosPowerTypes {
    ...
    public static <T extends PowerType> PowerConfiguration<T> register(String path,  Supplier<T> constructor) {
        PowerConfiguration<T> configuration = PowerConfiguration.simple(Lesbos.id(path), constructor);
